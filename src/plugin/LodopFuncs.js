...
export function getLodop(oOBJECT, oEMBED) {
    ...
    try {
        ...
        if (needCLodop()) {
            ...
            if (!LODOP) {
                _vue.$alert(`
                <p>Web打印服务CLodop未安装启动，点击这里<a href='http://www.lodop.net/download.html'  target='_blank' style='color:red;'>下载执行安装</a></p>
                <p>如果您已经下载并安装,请刷新页面</p>
                `, '提示', {
        ...
        LODOP.SET_LICENSES("","BB51A41DE2C7CA131AC033844AE7453A","C94CEE276DB2187AE6B65D56B3FC2848","");
